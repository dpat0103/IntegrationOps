...
class IntegrationCreate(BaseModel):
    ...
    availability_target_pct: float | None = Field(default=99.0, ge=0, le=100)
    p95_latency_target_ms: int | None = Field(default=1000, ge=1)
...
class IntegrationUpdate(BaseModel):
    ...
    availability_target_pct: float | None = Field(default=None, ge=0, le=100)
    p95_latency_target_ms: int | None = Field(default=None, ge=1)
...
class IntegrationRead(BaseModel):
    ...
    p95_latency_target_ms: int | None
