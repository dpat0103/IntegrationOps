    ...
    async def _check_one(self, integration_id: int) -> None:
        with self.session_factory() as session:
            ...
            await run_integration_check(
                ...
                allow_private_endpoints=self.settings.private_endpoints_allowed,
                integration_secret_key=self.settings.integration_secret_key,
                demo_mode=self.settings.demo_mode,
                demo_integration_url=self.settings.resolved_demo_integration_url,
            )
